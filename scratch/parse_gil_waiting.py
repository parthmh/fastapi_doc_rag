...
def main():
    ...
    # We want to find any frames containing lock, acquire, wait, gil, mutex, take_gil, etc.
    keywords = ["lock", "acquire", "wait", "gil", "mutex", "take_gil"]
    
    print("=== LOCK / GIL WAITING FRAMES IN SVG ===")
    matches = []
    for title in titles:
