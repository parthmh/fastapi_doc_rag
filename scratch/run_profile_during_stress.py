...
def main():
    # 1. Start run_locust_evaluation_csv.py in background
    print("Starting Locust evaluation in the background...")
    env = os.environ.copy()
    env["PYTHONUNBUFFERED"] = "1"
    proc = subprocess.Popen(
        [sys.executable, "-u", "scratch/run_locust_evaluation_csv.py"],
